...
export default function Home() {
  return (
    <div className="min-h-screen font-[family-name:var(--font-geist-sans)] bg-white text-[#1D1D1F]">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-white/80 border-b border-gray-100">
        <div className="container mx-auto py-5 px-6 flex items-center justify-between">
          <div className="flex items-center">
            <span className="font-medium text-xl tracking-tight">barid ai</span>
          </div>
          <nav className="hidden md:flex space-x-8">
            <a
              href="#features"
              className="text-sm font-medium text-[#1D1D1F] hover:text-blue-500 transition"
            >
              Features
            </a>
            <a
          ...
          <div className="flex items-center space-x-4">
            <a href="/login" className="text-sm font-medium text-[#1D1D1F] hover:text-blue-500 transition">
              Login
            </a>
            <a href="/signup" className="bg-blue-500 text-white px-5 py-1.5 rounded-full text-sm font-medium hover:bg-blue-600 transition">
              Get Started
            </a>
          </div>
        </div>
      ...
      <main className="pt-16 pb-24">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-[#86868B] max-w-3xl mx-auto mb-10 leading-relaxed">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href="#how-it-works"
                className="bg-[#F5F5F7] text-[#1D1D1F] hover:bg-[#E8E8ED] transition px-8 py-3 rounded-full text-sm font-medium"
              >
                Learn More
              </a>
            </div>
                ...
                <div className="bg-white rounded-3xl overflow-hidden shadow-2xl border border-gray-100">
                  ...
                  <div className="bg-white p-4 flex items-center justify-between border-b border-gray-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-[#86868B]">Online now</p>
                      </div>
                    </div>
                    <div className="flex gap-2">
                      <button className="w-8 h-8 rounded-full bg-[#F5F5F7] flex items-center justify-center">
                        <svg
                  ...
                  <div className="p-4 bg-white h-[340px] overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-0 right-0 flex justify-center">
                      <div className="flex items-center bg-white rounded-full px-5 py-3 shadow-lg border border-gray-100">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-8 w-full justify-center">
          ...
          <div className="flex-1 bg-white dark:bg-gray-900 rounded-xl shadow p-6 flex flex-col items-center border border-gray-200 dark:border-gray-800">
            ...
            <a href="/signup" className="mt-auto bg-blue-600 text-white px-6 py-2 rounded-full font-semibold hover:bg-blue-700 transition">
              Start Free
            </a>
          </div>
          {/* Smart AI Plan */}
          <div className="flex-1 bg-white dark:bg-gray-900 rounded-xl shadow p-6 flex flex-col items-center border-2 border-blue-600">
            ...
            <a href="/signup?plan=premium" className="mt-auto bg-blue-600 text-white px-6 py-2 rounded-full font-semibold hover:bg-blue-700 transition">
              Upgrade Now
            </a>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {/* Step 1 */}
              <div className="rounded-3xl bg-[#F5F5F7] p-8 transform transition-all duration-300 hover:scale-[1.03] hover:shadow-lg">
                <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center mb-6 text-blue-600 font-semibold text-xl">
                  1
                </div>
                <h3 className="text-xl font-medium mb-3 text-[#1D1D1F]">
              ...
              {/* Step 2 */}
              <div className="rounded-3xl bg-[#F5F5F7] p-8 transform transition-all duration-300 hover:scale-[1.03] hover:shadow-lg">
                <div className="w-12 h-12 rounded-full bg-purple-100 flex items-center justify-center mb-6 text-purple-600 font-semibold text-xl">
                  2
                </div>
                <h3 className="text-xl font-medium mb-3 text-[#1D1D1F]">
              ...
              {/* Step 3 */}
              <div className="rounded-3xl bg-[#F5F5F7] p-8 transform transition-all duration-300 hover:scale-[1.03] hover:shadow-lg">
                <div className="w-12 h-12 rounded-full bg-pink-100 flex items-center justify-center mb-6 text-pink-600 font-semibold text-xl">
                  3
                </div>
                <h3 className="text-xl font-medium mb-3 text-[#1D1D1F]">
              ...
              {/* Step 4 */}
              <div className="rounded-3xl bg-[#F5F5F7] p-8 transform transition-all duration-300 hover:scale-[1.03] hover:shadow-lg">
                <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center mb-6 text-green-600 font-semibold text-xl">
                  4
                </div>
                <h3 className="text-xl font-medium mb-3 text-[#1D1D1F]">
                  Analyze & Improve
            ...
            <div className="mt-16 relative">
              ...
              <div className="bg-white/80 backdrop-blur-sm border border-gray-100 rounded-3xl p-8 shadow-xl">
                <div className="flex flex-col md:flex-row items-center gap-8">
                  <div className="w-full md:w-1/2">
                    <div className="aspect-[4/3] relative bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl overflow-hidden border border-gray-100">
                      <div className="absolute top-0 left-0 right-0 h-12 bg-white/80 backdrop-blur-sm border-b border-gray-100 flex items-center px-4">
                        <div className="flex gap-2">
                          <div className="w-3 h-3 rounded-full bg-red-400"></div>
                          <div className="w-3 h-3 rounded-full bg-yellow-400"></div>
                          <div className="w-3 h-3 rounded-full bg-green-400"></div>
                        </div>
                        <div className="mx-auto text-xs text-[#86868B]">
                          Barid AI Dashboard
                        </div>
                      </div>
      ...
      <section className="py-24 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="text-center">
            ...
            <p className="text-xl text-[#86868B] mb-10 max-w-3xl mx-auto">
      ...
      <footer className="container mx-auto py-8 px-4 flex flex-col md:flex-row justify-between items-center border-t border-gray-200 mt-16">
        <div className="flex items-center mb-4 md:mb-0">
          <div className="bg-[#F5F5F7] p-1.5 rounded-md mr-2">
            <span className="font-bold text-sm text-blue-600">B</span>
          </div>
        ...
        <div className="flex space-x-6">
          <a
            href="#"
            className="text-sm text-[#86868B] hover:text-blue-500 transition"
          >
            Privacy
          </a>
          <a
